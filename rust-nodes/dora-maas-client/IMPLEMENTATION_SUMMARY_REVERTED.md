...
**File**: `rust-nodes/dora-maas-client/src/config.rs`
...
**File**: `rust-nodes/dora-maas-client/src/main.rs`
...
**File**: `rust-nodes/dora-conference-bridge/src/main.rs`
...
1. `rust-nodes/dora-maas-client/src/config.rs` - Removed cancellation output config
2. `rust-nodes/dora-maas-client/src/main.rs` - Removed send_cancellation_event, updated error handling
